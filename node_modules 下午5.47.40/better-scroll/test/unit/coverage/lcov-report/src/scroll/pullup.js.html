...
<span class="cstat-no" title="statement not covered" >    if (this._prevProbeType) {</span>
<span class="cstat-no" title="statement not covered" >      this.options.probeType = this._prevProbeType</span>
    }
